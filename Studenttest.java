...
public class Studenttest {
	...
	public static void main(String[] args) {
		...
		Student studenta = new Student(20, "shyam", 25, 100);
		Student studenta1 = new Student(10, "ravi", 50, 95);
		Student studenta2 = new Student(50, "raj", 40, 65);
		Student studenta3 = new Student(40, "kala", 27, 40);
		Student studenta4 = new Student(30, "prathi", 24, 98);
